...
class MetaLearner(nn.Module):
    ...
    Inputs (per step) [Size: 12]:
    - State Feature (latent dim 8)
    - Last Action (scalar 1)
    - Last Reward (scalar 1)
    - Gradient Norm (scalar 1) - Stability metric
    - Energy Delta (scalar 1) - Progress metric
    ...
    def __init__(self, input_dim=12, hidden_dim=64):
        ...
        # 1. LR Scale (Log-Normal usually better, but Normal with Softplus is fine)
