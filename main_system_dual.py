...
def main():
    ...
    # Input Dim 7: Consistency(1)+Symmetry(1)+Density(1)+Act(1)+Rew(1)+Grad(1)+Delta(1)
    ...
    for step in range(1, 1001):
        try:
            ...
            # Consistency(1), Symmetry(1), Density(1), Action(1), Reward(1), Grad(1), Delta(1)
            ...
            # Nirvana Check
            if hormones['serotonin'] > 0.9 and hormones['cortisol'] < 0.1 and world_energy < 0.2:
